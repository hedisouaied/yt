...
class ServiceController extends Controller
{
    ...
    {
        $blog = Service::orderby('id', 'DESC')->get();

        return view('backend.service.index', compact('blog'));
    ...
    public function store(Request $request)
    {
        ...
        if ($status) {
            return redirect()->route('service.index')->with('success', 'Service crée avec succès');
        } else {
    ...
    public function edit($id)
    {
        ...
        if ($blog) {
            return view('backend.service.edit', compact('blog'));
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($blog) {
            ...
            if ($status) {
                return redirect()->route('service.index')->with('success', 'Service modifiée avec succès');
            } else {
                return back()->with('error', 'something went wrong!');
            }
        } else {
